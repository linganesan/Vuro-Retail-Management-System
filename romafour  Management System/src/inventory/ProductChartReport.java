...
Connection connection =null;
	...
	try {
		...
		connection = DriverManager.getConnection("jdbc:mysql://localhost/romafour","root","");
	...
	private void build() {
		...
		TextColumnBuilder<String> itemColumn = col.column("Product", "Product_Name", type.stringType());
                ...
                TextColumnBuilder<String> productType = col.column("Product Type", "Product_Type_Code", type.stringType());
		...
		try {
			report()
				...
				.pageFooter(Templates.footerComponent)
                                .setDataSource("SELECT  Product_Name,Product_Id,Product_Type_Code, Total_Quantity,price FROM products",connection)
				.show();
